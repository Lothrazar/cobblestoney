...
public class BlockRegistry {
  ...
  public static final RegistryObject<Block> DIRT_SAND = BLOCKS.register("dirt_sand", () -> new Block(Block.Properties.of(Material.DIRT, MaterialColor.SAND).requiresCorrectToolForDrops().strength(0.5F).sound(SoundType.SOUL_SAND)));
